...
<table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
	<tr>
		<td align="left" class="nav"><a href="{U_INDEX}" class="navLarge">{L_INDEX}</a></td>
	</tr>
</table>
...
<table class="forumline" width="100%" cellspacing="1" cellpadding="3" border="0" align="center">
	...
	<tr>
		<td class="spaceRow" height="1"><img src="templates/fierce/images/spacer.gif" alt="" width="1" height="1" /></td>
	</tr>
	<!-- END faq_row -->
</table>
