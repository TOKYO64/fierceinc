...
$config['dbms'] = 'mysql';
$config['db_hostname'] = 'cookie.luxmedia.com';
$config['db_username'] = 'fierce2009';
$config['db_password'] = 'l3ader$h1p';
$config['db_name'] = 'fierce_staging_cms';
...
#e.g. http://blah.com
$config['root_url'] = 'http://staging.fierceinc.com';
...
$config['root_path'] = '/var/www/fierce/staging.fierceinc.com';

#Name of the admin directory
$config['admin_dir'] = 'admin';

#Where do previews get stored temporarily?  It defaults to tmp/cache.
$config['previews_path'] = '/var/www/fierce/staging.fierceinc.com/tmp/cache';

#Where are uploaded files put?  This defaults to uploads.
$config['uploads_path'] = '/var/www/fierce/staging.fierceinc.com/uploads';
...
$config['image_uploads_path'] = '/var/www/fierce/staging.fierceinc.com/uploads/images';
